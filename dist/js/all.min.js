...
!function(){"use strict";function e(e){if(!e)throw"You must provide an URL to scrape (YQL).";this.url=e}function r(e){if(!e)throw"You must provide an URL to request (JSONP).";this.url=encodeURIComponent(e)}function a(e){if(!e)throw"You must provide an URL to request (CORS).";this.url=encodeURIComponent(e)}function n(e){this.attrs=e}function o(e,t){return jQuery("<div>").html(e).xpath(t).toArray()}function i(){return navigator.vendor&&navigator.vendor.indexOf("Apple")>-1&&navigator.userAgent&&!navigator.userAgent.match("CriOS")}e.prototype={select:function(e){return this.httpGet(this.buildQuery(e))},buildQuery:function(e){var t="where url='"+this.url+"'";for(var r in e)e[r]&&(t+=" and "+r+" = '"+e[r]+"'");return"select * from html "+t},httpGet:function(e){var t=jQuery.Deferred();return jQuery.ajax({url:"https://query.yahooapis.com/v1/public/yql",data:{q:e,format:"json",jsonCompat:"new"},dataType:"jsonp"}).done(function(e){e.query&&e.query.count?t.resolve(e.query.results):t.reject("No results found")}).error(t.reject),t.promise()}},r.prototype={select:function(e){var t=jQuery.Deferred(),r=e.xpath;return jQuery.ajax({url:"https://jsonp.afeld.me/?callback=?&url="+this.url,dataType:"jsonp"}).done(function(e){e&&e.data?t.resolve({img:jQuery(e.data).find(r).toArray()}):t.reject("No results found")}).error(t.reject),t.promise()}},a.prototype={select:function(e){var t=jQuery.Deferred(),r=e.xpath;return jQuery.ajax({url:"https://simple-cors.herokuapp.com/?url="+this.url}).done(function(e){var a=e?o(e,r):[];a.length?t.resolve({img:a}):t.reject("No results found")}).error(t.reject),t.promise()}};var s={t:t,render:function(e,t){var r=new s.t(document.getElementById("js-"+e+"-template").innerHTML);return r.render(t)}},c={_loading:!1,load:function(e,t){if(c._loading)return void setTimeout(c.load.bind(c,e,t),1e3);c._loading=!0;var r=jQuery("<iframe>",{src:e.src,width:e.width,height:e.height}).css("display","none"),a=jQuery(t).find(".placeholder.loading");a.children().replaceWith(r),r.load(function(){a.removeClass("placeholder loading"),r.slideDown(),c._loading=!1})}},l=function(e){this.type=e,this.id="js-"+this.type+"-items",this.el=document.getElementById(this.id)};l.prototype={appendImages:function(e){e.forEach(this.appendImage.bind(this))},appendImage:function(e){var t=document.createElement("img");t.src=e.src,t.className="img-responsive";var r=jQuery("<a>",{href:e.src,"data-lightbox":this.type}).append(t),a=jQuery("<div>",{"class":"col-xs-12 col-sm-6 col-md-4","data-toggle":"tooltip","data-placement":"top",title:e.title});a.append(r).appendTo(this.el),t.onerror=function(){a.remove()}},placeholder:function(e){jQuery("<div>",{"class":"col-xs-12 placeholder"}).append(e).appendTo(this.el)},iframe:function(e){c.load(e,this.el)},loading:function(){jQuery(this.el).find(".placeholder").addClass("loading")}},n.prototype={render:function(){return jQuery("#js-main").append(s.render("supermarket",this.attrs)),this.load()},load:function(){return this.select().done(this.appendFromResults.bind(this)).fail(this.appendFallbackIframe.bind(this))},select:function(){var e=a;if(this.attrs.links){var t=this.attrs.links.map(function(t){return new e(t).select({xpath:this.attrs.select})},this);return jQuery.when.apply(jQuery,t)}return new e(this.attrs.link).select({xpath:this.attrs.select})},appendFromResults:function(e){var t=this.attrs.extractOffers(1===arguments.length?e:Array.prototype.slice.call(arguments));new l(this.attrs.key).appendImages(t)},appendFallbackIframe:function(e){var t=this.attrs.link,r=new l(this.attrs.key),a=s.render("notice",{link:t});if(i())return void r.placeholder(a);var n=jQuery("<span>",{"class":"js-iframe-notice",html:a+" o "});jQuery("<a>",{href:t,text:"cargarlo aquí"}).on("click",function(){return r.loading(),r.iframe({src:t,width:"100%",height:"1000"}),!1}).appendTo(n);r.placeholder(n)}};var u=[{key:"carrefour",name:"Carrefour",link:"http://www.carrefour.com.ar/promociones",select:'//div[contains(@class, "promo-landing-content-principal-image")]/img',extractOffers:function(e){return e.img.length?e.img:[e.img]}},{key:"coto",name:"Coto",link:"http://www.coto.com.ar/ofe/ofe3/index.html",select:'//div[contains(@class, "list_images")]/img',extractOffers:function(e){return e.img.map(function(e){var t=e.src.replace(e.baseURI,"");return{src:"http://www.coto.com.ar/ofe/ofe3/"+t}})}},{key:"dia",name:"Dia",link:"https://www.supermercadosdia.com.ar/ofertas/",links:["https://www.supermercadosdia.com.ar/category/dia-market","https://www.supermercadosdia.com.ar/category/dia-mini","https://www.supermercadosdia.com.ar/category/dia-plus"],select:'//ul[contains(@class, "slides")]/li/img',extractOffers:function(e){var t=["Dia Market","Dia Mini","Dia Plus"],r=[];return e.forEach(function(e,a){var n=t[a];e.img.length||(e.img=[e.img]),e.img.forEach(function(e){r.push({src:e.src,title:n})})}),r}},{key:"diaahorrames",name:"Dia (ahorrames)",link:"https://www.supermercadosdia.com.ar/ahorramesdia/",select:'//img[contains(@class, "aligncenter")]',extractOffers:function(e){return[{src:e.img.src}]}},{key:"jumbo",name:"Jumbo",link:"https://www.jumbo.com.ar/Comprar/Home.aspx#_atCategory=true&_atGrilla=false&_id=5",select:'//div[@class="owl-item"]/img[@class="desktop"]',extractOffers:function(e){return e.img}},{key:"disco",name:"Disco",link:"https://www.disco.com.ar/Comprar/Home.aspx#_atCategory=true&_atGrilla=false&_id=75",select:'//div[@class="owl-item"]/img[@class="desktop"]',extractOffers:function(e){return e.img}}],d=u.map(function(e){return new n(e).render()});jQuery.when.apply(jQuery,d).always(function(){window.scrollTo(0,0),jQuery("body").scrollspy({target:"#navbar-supermarkets",offset:60}),imagesLoaded(document.getElementById("js-main"),function(){setTimeout(function(){jQuery("#js-social-buttons").trigger("mouseover")},1e3),jQuery("#js-loading").fadeOut("fast"),jQuery("#js-footer").removeClass("hidden"),jQuery('[data-toggle="tooltip"]').tooltip()})}),jQuery(".js-supermarket-nav").on("click",function(e){var t=this.hash;e.preventDefault(),jQuery("html, body").animate({scrollTop:jQuery(t).offset().top},300,function(){window.location.hash=t})}),jQuery("#js-main").on("click",".js-supermarket-hide",function(e){var t=jQuery(this).data("selector");this.innerText={"Ocultar ↑":"Mostrar ↓","Mostrar ↓":"Ocultar ↑"}[this.innerText],jQuery(t).toggleClass("hidden"),e.preventDefault()}).on("click",".js-caption-link",function(e){var t=jQuery(this).data("selector");jQuery(t).click(),e.preventDefault()}),jQuery("#js-social-buttons").one("mouseover",function(){Socialite.setup({facebook:{lang:"es_LA"},twitter:{lang:"es_LA"}}),Socialite.load()}),lightbox.option({albumLabel:"%1 / %2"})}();
//# sourceMappingURL=data:application/json;charset=utf8;base64,
